...
using CommunicationService.Infrastructure.Providers;
using CommunicationService.Infrastructure.Templates;
using Microsoft.OpenApi.Models;
using CommunicationService.Worker;
using CommunicationService.Application.Handlers;
using CommunicationService.Infrastructure.Rates;
using CommunicationService.Infrastructure.Circuit;
